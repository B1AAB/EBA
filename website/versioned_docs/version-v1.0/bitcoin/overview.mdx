...
on pre-sampled communities.
    ...
    *   [101 Jupyter Notebook](https://github.com/B1AAB/GraphStudio/blob/main/g101/g101.ipynb).
...
you can create more relevant datasets and develop more effective models.
    ...
    *   **Requirements**: 
        ...
        requires ~4.3TB of total storage. 
        The sampling process itself can take hours to days 
        on machines with limited resources.
    *   [Restore the graph database](/docs/bitcoin/etl/restore), 
        then [sample](/docs/bitcoin/sampling/overview) your application-specific communities.
