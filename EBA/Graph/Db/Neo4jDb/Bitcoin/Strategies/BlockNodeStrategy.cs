...
public class BlockNodeStrategy(bool serializeCompressed) : StrategyBase(serializeCompressed)
{
    ...
    [
        ...
        new(nameof(b.Confirmations), FieldType.Long, n => n.BlockMetadata.Confirmations),
        new(nameof(b.Version), FieldType.Long, n => n.BlockMetadata.Version),
        ...
        new(nameof(b.Time), FieldType.Long, n => n.BlockMetadata.Time),
        new(nameof(b.MedianTime), FieldType.Long, n => n.BlockMetadata.MedianTime),
        new(nameof(b.Nonce), FieldType.Long, n => n.BlockMetadata.Nonce),
        new(nameof(b.Bits), FieldType.String, n => n.BlockMetadata.Bits),
        new(nameof(b.Difficulty), FieldType.Double, n => n.BlockMetadata.Difficulty),
        new(nameof(b.Chainwork), FieldType.String, n => n.BlockMetadata.Chainwork),
        new(nameof(b.TransactionsCount), FieldType.Long, n => n.BlockMetadata.TransactionsCount),
        ...
        new(nameof(b.StrippedSize), FieldType.Long, n => n.BlockMetadata.StrippedSize),
        new(nameof(b.Size), FieldType.Long, n => n.BlockMetadata.Size),
        new(nameof(b.Weight), FieldType.Long, n => n.BlockMetadata.Weight),
        new(nameof(b.CoinbaseOutputsCount), FieldType.Long, n => n.BlockMetadata.CoinbaseOutputsCount),
        new(nameof(b.TxFees), FieldType.Long, n => n.BlockMetadata.TxFees),
        new(nameof(b.MintedBitcoins), FieldType.Long, n => n.BlockMetadata.MintedBitcoins),
